...
RSpec.describe Backend::Invites::Create do
  describe '#call' do
    it 'creates a pending invite and delivers it by email' do
      ...
      result = described_class.new.call(project: project, email: 'new@example.com', role: 'member',
    ...
    it 'supersedes an earlier pending invite for the same project/email' do
      ...
      first_result = described_class.new.call(project: project, email: 'new@example.com', role: 'member',
                                              invited_by_user: nil)
