  ...
  class Routes < Hanami::Routes
    ...
    scope "api/v1" do
      ...
      scope "admin" do
        ...
        post "/projects/:project_id/llm_provider_configs/models", to: "api.v1.admin.projects.llm_provider_configs.models"
        ...
        post "/projects/:project_id/translations/bulk_regenerate", to: "api.v1.admin.projects.translations.bulk_regenerate"
        ...
        post "/projects/:project_id/translations/by_key/:key/locales", to: "api.v1.admin.projects.translations.add_locale"
